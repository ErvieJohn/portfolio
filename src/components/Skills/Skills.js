        ...
        <div className="skills">
          <div className="card">
            <div className='skills-container-content'>
              <h4 className='h4-items'>&#x2022; Able to use different operating
                systems such as Windows/Linux
              </h4>
              <h4 className='h4-items'>&#x2022; Network Security and Automation
              </h4>
              <h4 className='h4-items'>&#x2022; Database Management
              </h4>
              <h4 className='h4-items'>&#x2022; Hardware Troubleshooting
              </h4>
              <h4 className='h4-items'>&#x2022; Network Troubleshooting
              </h4>
              <h4 className='h4-items'>&#x2022; Linux Scripting
              </h4>
            </div>
          </div>
        </div>
